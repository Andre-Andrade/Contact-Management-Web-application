    ...
    <div class="nav sticky-top bg-dark d-flex justify-content-between">
        ...
        <div class="nav-links ">
            <ul>
                ...
                <li><a class="navbar-brand h1" href="{{ route('contatos') }}">Contatos</a></li>
                 <li><a class="navbar-brand h1" href="{{ route('index') }}">Login</a></li>
                <li><a class="navbar-brand h1" href="{{ route('contatos') }}">Registrar</a></li>
            </ul>
        </div>
    </div>
